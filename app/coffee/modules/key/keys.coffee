...
module.exports = [
    ...
    # # NUMPAD KEYS
    # { row: 'num_r0', key: 'n_0', keycode: 49, css: 'w2_25' }
    # { row: 'num_r0', key: 'n_.', keycode: 49 }

    # { row: 'num_r1', key: 'n_1', keycode: 49 }
    # { row: 'num_r1', key: 'n_2', keycode: 50 }
    # { row: 'num_r1', key: 'n_3', keycode: 51 }

    # { row: 'num_r2', key: 'n_4', keycode: 52 }
    # { row: 'num_r2', key: 'n_5', keycode: 53 }
    # { row: 'num_r2', key: 'n_6', keycode: 54 }

    # { row: 'num_r3', key: 'n_7', keycode: 55 }
    # { row: 'num_r3', key: 'n_8', keycode: 56 }
    # { row: 'num_r3', key: 'n_9', keycode: 57 }

    # { row: 'num_r4', key: 'n_CLEAR', keycode: 48 }
    # { row: 'num_r4', key: 'n_/', keycode: 189 }
    # { row: 'num_r4', key: 'n_*', keycode: 187 }

    # { row: 'num_col', key: 'n_-', keycode: 48 }
    # { row: 'num_col', key: 'n_+', keycode: 189, css: 'h2_0' }
    # { row: 'num_col', key: 'n_ENTER', keycode: 187, css: 'h2_0' }
